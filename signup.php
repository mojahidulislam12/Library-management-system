...
<body background="imeages">
	<nav class="navbar navbar-expand-lg navbar-secondary bg-secondary ">
		<div class="container-fluid">
		    ...
		    <ul class="nav navbar-nav navbar-right">
		      ...
		      <li class="nav-item">
		        <a class="nav-link btn btn-success A" href="#"></span>Register</a>
		      </li>
		      <li class="nav-item">
		        <a class="nav-link btn btn-info A" href="index.php"> UsersLogin</a>
		      </li>
		    </ul>
		</div>
	</nav><br>
	...
	<div class="" id="side_bar">
		...
		<div class="col-md-8 " id="main_content">
			<center><h3 class="text-black">User Registration</h3></center>
			<form action="register.php" method="post">
				...
				<button type="submit" class="btn btn-outline-primary A">Register</button>	
			</form>
		</div>
	</div>
</body>
