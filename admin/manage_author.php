					...
					<?php
						...
						while ($row = mysqli_fetch_assoc($query_run)){
							...
							<tr>
								...
								<td><button class="btn btn-outline-success"><a href="edit_author.php?aid=<?php echo $row['author_id'];?>">Edit</a></button>
								<button class="btn btn-outline-danger"><a href="delete_author.php?aid=<?php echo $row['author_id'];?>">Delete</a></button></td>
							</tr>
							<?php
						}
					?>
